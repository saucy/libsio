////////////////////////////////////////////////////////////////////////////////
// This is taken straight from SDL2 SDL_scancode.h
...
/*     KEY_LOCKINGSCROLLLOCK = 132, */
    ...
    SIO_NUM_SCANCODES = 512 /**< not a key, just marks the number of scancodes
                                 for array bounds */
};

/////////////////////////////////////////////////////////////////////
// Taken straight from SDL2 SDL_keycode.h
/**
...
enum {
	...
	//////////////////////////////////////////////////////////////
	// In SDL they use #define's for these last 4
	// Instead we're going to use enum's to be consistent with
	// no #define's that libsio takes on.
